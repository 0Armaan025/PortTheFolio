      ...
      <div class="mx-auto max-w-screen-xl px-4 py-8 sm:py-12 sm:px-6 lg:py-16 lg:px-8">
        <div class="grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-16">
          ...
          >
            ...
            <div class="mt-8  flex lg:flex-row md:flex-col">
              <button class="hover:bg-teal-700 bg-teal-600 text-white transition inline-flex py-3 px-5 rounded-lg items-center  focus:outline-none">
                <svg
                ...
                <span class="ml-4 flex items-start flex-col leading-none">
                  <span class="text-xs text-gray-200 mb-1">Get it on</span>
                  <span class="title-font font-medium">Google Play</span>
                </span>
              </button>
              <button class="bg-gray-100 inline-flex py-3 px-5 rounded-lg items-center lg:ml-4 md:ml-0 ml-4 md:mt-4 mt-0 lg:mt-0 hover:text-teal-600/75 text-teal-600 transition focus:outline-none">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="currentColor"
                  class="w-6 h-6"
